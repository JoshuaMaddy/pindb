"""
htpy page and fragment builders: `templates/components/pins/pin_lightbox.py`.
...
ancestor stacking context (e.g. ``main``). Logic lives in ``templates/js/pins/pin_lightbox.js``.
"""
