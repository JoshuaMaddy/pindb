...
CATEGORY_COLORS: dict[TagCategory, str] = {
    ...
    TagCategory.meta: "bg-tag-meta text-tag-meta-fg fill-tag-meta-fg stroke-tag-meta-fg border-tag-meta-fg",
...
CATEGORY_HOVER_CLASSES: dict[TagCategory, str] = {
    ...
    TagCategory.meta: "hover:border-tag-meta-hover hover:text-tag-meta-hover hover:fill-tag-meta-hover hover:stroke-tag-meta-hover hover:border-tag-meta-hover",
