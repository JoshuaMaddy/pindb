...
CATEGORY_HOVER_CLASSES: dict[TagCategory, str] = {
    ...
    TagCategory.archetype: "hover:border-tag-archetype-hover hover:text-tag-archetype-hover hover:fill-tag-archetype-hover hover:stroke-tag-archetype-hover hover:border-tag-archetype-hover",
    ...
    TagCategory.company: "hover:border-tag-company-hover hover:text-tag-company-hover hover:fill-tag-company-hover hover:stroke-tag-company-hover hover:border-tag-company-hover",
