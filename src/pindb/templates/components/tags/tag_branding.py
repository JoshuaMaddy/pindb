...
CATEGORY_COLORS: dict[TagCategory, str] = {
    ...
    TagCategory.person: "bg-tag-person text-tag-person-fg fill-tag-person-fg stroke-tag-person-fg border-tag-person-fg",
...
CATEGORY_HOVER_CLASSES: dict[TagCategory, str] = {
    ...
    TagCategory.person: "hover:border-tag-person-hover hover:text-tag-person-hover hover:fill-tag-person-hover hover:stroke-tag-person-hover hover:border-tag-person-hover",
