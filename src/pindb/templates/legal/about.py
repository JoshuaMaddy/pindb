...
def about_page(request: Request) -> Element:
    ...
    return html_base(
        ...
        body_content=legal_container(
            div[
                h1(class_="text-3xl font-bold mb-2")["About PinDB"],
                p(class_="text-pin-base-200 mb-6")[f"Version {__version__}"],
                h2(class_="text-xl font-semibold mt-6 mb-2")["What is PinDB?"],
                p(class_="mb-4")[
                ...
                h2(class_="text-xl font-semibold mt-6 mb-2")["How it works"],
                p(class_="mb-4")[
                ...
                h2(class_="text-xl font-semibold mt-6 mb-2")["Who runs this service?"],
                p(class_="mb-4")[
                ...
                h2(class_="text-xl font-semibold mt-6 mb-2")["Getting in touch"],
                p(class_="mb-2")[
                ...
                h2(class_="text-xl font-semibold mt-6 mb-2")["Related pages"],
